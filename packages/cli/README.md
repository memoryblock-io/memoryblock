...
Command-line interface for the **memoryblock** ecosystem.

This package provides the `mblk` command to deploy, manage, and monitor isolated multi-agent AI assistants.
